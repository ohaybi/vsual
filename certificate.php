...
<html lang="en">
  <head>
    ...
    <title>Sertifikat <?= $kreatorAccount["nama_kreator"]; ?> | Vsual.</title>
        ...
        <div class="container max-w-5xl">
            ...
            <div class="flex flex-col md:flex-row gap-4 md:gap-16">
                <div class="flex flex-row md:flex-col text-xs md:text-sm">
                    ...
                    <a href="certificate.php" class="font-bold text-primary bg-primary/10 p-4 rounded-xl">Sertifikat</a>
                </div>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <ul class="flex flex-col gap-8">
                        <li class="flex flex-col gap-2">
                            ...
                            <input type="text" name="judul" id="judul" placeholder="Judul sertifikat.." maxlength="100" required class="ring-1 ring-abu focus:ring-primary focus:outline-none rounded-lg px-4 py-2">
                        </li>
                        <li class="flex flex-col gap-2">
                            <label for="nama_institusi">Nama Institusi</label>
                            <input type="text" name="nama_institusi" id="nama_institusi" maxlength="100" placeholder="Penerbit sertifikat.." required class="ring-1 ring-abu focus:ring-primary focus:outline-none rounded-lg px-4 py-2">
                        </li>
                        <li class="flex flex-col gap-2">
                            <label for="tahun">Tahun Diterbitkan</label>
                            <input type="text" name="tahun" id="tahun" placeholder="2022" pattern="\d{4,4}" maxlength="4" required class="ring-1 ring-abu focus:ring-primary focus:outline-none rounded-lg px-4 py-2">
                        </li>
                        <li class="self-end">
                            <button type="submit" name="submit" class="text-xs md:text-sm bg-primary text-putih px-4 py-2 rounded-md shadow-lg">Tambah Sertifikat</button>
                        </li>
                    </ul>
                </form>
            </div>
